...
|---|---|---|
| Vega light | Full P0/P1 state matrix, supporting surfaces, all overlay triggers | [Page 1](screenshots/default-light-vega-page-01.png), [page 2](screenshots/default-light-vega-page-02.png), [page 3](screenshots/default-light-vega-page-03.png), [page 4](screenshots/default-light-vega-page-04.png) |
| Vega dark | Full P0/P1 state matrix, supporting surfaces, all overlay triggers | [Page 1](screenshots/default-dark-vega-page-01.png), [page 2](screenshots/default-dark-vega-page-02.png), [page 3](screenshots/default-dark-vega-page-03.png), [page 4](screenshots/default-dark-vega-page-04.png) |
| Nova light | Default, disabled, invalid, loading, supporting surfaces, representative overlays | [Page 1](screenshots/default-light-nova-page-01.png), [page 2](screenshots/default-light-nova-page-02.png), [page 3](screenshots/default-light-nova-page-03.png), [page 4](screenshots/default-light-nova-page-04.png) |
| Nova dark | Default and representative overlay geometry | [Page 1](screenshots/default-dark-nova-page-01.png), [page 2](screenshots/default-dark-nova-page-02.png), [page 3](screenshots/default-dark-nova-page-03.png), [page 4](screenshots/default-dark-nova-page-04.png) |
| Maia light | Default, disabled, invalid, loading, supporting surfaces, representative overlays | [Page 1](screenshots/default-light-maia-page-01.png), [page 2](screenshots/default-light-maia-page-02.png), [page 3](screenshots/default-light-maia-page-03.png), [page 4](screenshots/default-light-maia-page-04.png) |
| Maia dark | Default and representative overlay geometry | [Page 1](screenshots/default-dark-maia-page-01.png), [page 2](screenshots/default-dark-maia-page-02.png), [page 3](screenshots/default-dark-maia-page-03.png), [page 4](screenshots/default-dark-maia-page-04.png) |
...
Accordion and keyed Collapsible now measure dynamic content height, keep closing content mounted for the Style motion duration, ignore stale close completion after an interrupted reopen, and unmount after a matching close. Three pure lifecycle tests cover dynamic retargeting, interruption, and final unmount. A GPUI interaction test also advances focus to the Accordion trigger and verifies that `Space` invokes the controlled toggle callback exactly once; a pure key-contract test covers unmodified `Enter` and `Space`. The fixed Story capture verifies the open layout without clipping, and custom trigger content can provide an explicit `aria_label`.
