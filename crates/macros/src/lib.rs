...
// Changes:
// - Updated generated plot code to use the renamed `Column::w` width builder.
...
///   `IconName` enum in `hearth-gpui` uses this pattern to consume icons from
///   `hearth-gpui-assets` without a sibling-crate reference, which would
