...
// Changes:
// - Added examples for `menu_with_check`.
use gpui::*;
use gpui::{
    Action, App, AppContext, Axis, Context, Entity, FocusHandle, Focusable, IntoElement,
    ParentElement, Render, Styled, Window,
};
use hearth_gpui::{AxisExt, h_flex, menu::DropdownMenu as _};
use hearth_gpui::{
    Sizable as _, Size,
    button::Button,
    checkbox::Checkbox,
    ...
    fn new(_: &mut Window, cx: &mut Context<Self>) -> Self {
        let items = vec![
            ...
            (
                ...
                \n\n \
                You can easily create your native desktop application by using Hearth GPUI.
                ",
                3,
            ),
            ("Version", "0.1.0", 1),
