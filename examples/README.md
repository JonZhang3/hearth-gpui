# Hearth GPUI basic examples

This folder contains basic examples of how to use the Hearth GPUI library. Each example demonstrates a specific feature or functionality of the library.
...
4. Following the code style and name style used in the existing examples or in entire of Hearth GPUI.
